...
##'
##' \code{gnlrim_dotc} fits user-specified nonlinear regression equations to one or
...
##' id <- rep(1:4, each=5)
##'
##' gnlrim_dotc(y, mu=~a+b*dose+rand, random="rand", nest=id, pmu=c(a=8.7,b=0.25),
...
gnlrim_dotc <- function(y=NULL, distribution="normal", mixture="normal-var",
